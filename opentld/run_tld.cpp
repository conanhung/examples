...
int main(int argc, char * argv[]){
	...
	/*capture.open("E://TAVI//datasets//19_MEN_JAC//new-all.mov");
	roi = Rect(237,180,110,140);
	box = Rect(287-237,260-180,35,24);*/

	video="E://TAVI//interventions//201303191200REVNIC//201303191200REVNIC3//201303191200REVNIC3.mov";
	capture.open(video);
	...
	// ok
	/*capture.open("E://TAVI//interventions//201303261000HELMAR//20130326104057//20130326104057.mov");
	roi = Rect(835,328,200,200);
	box = Rect(885-835,375-328,53,27);
	rep=false;*/

	// failed
	/*capture.open("E://TAVI//DUVAL_MARCEL//videoHD_2013-03-26_14-03-38_00000.avi");
	roi = Rect(400,243,197,146);
	box = Rect(474-400,303-243,30,27);*/
...
REPEAT:
		...
		while(true){
			...
			// process frame
			tld.processFrame(last_gray,current_gray,pts1,pts2,pbox,status,true,false,bb_file);
			obox = pbox;
